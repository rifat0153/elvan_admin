...
final defaultTimerProvider = NotifierProvider<SettingNotifier, DefaultTimerState>(SettingNotifier.new);
...
class SettingNotifier extends Notifier<DefaultTimerState> {
  ...
  setTakingHour(bool isTaking) {
    ...
    ref.read(settingUsecaseProvider).setDefaultTimer(Setting(defaultTime: state.minutes, notice: state.notice, takingOrder: state.takingHour));
  }
